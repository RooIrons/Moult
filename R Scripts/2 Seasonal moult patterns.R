...
print(plot1 + ggtitle("Streaky-headed Seedeater"))  
...
GEW_867 <- ggplot(data = filter(ringing_data, !is.na(gender), !is.na(West_East)), 
...
print(GEW_867 + ggtitle("Streaky-headed Seedeater"))
...
print(A_Sunbird + ggtitle("Drakensberg Siskin"))  
